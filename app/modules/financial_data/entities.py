...
Tables:
    ...
    - financial_planning_tip: AI-generated financial planning tips.
"""
...
class FinancialPlanningTip(Base, AuditMixin):
    """Financial planning tips generated by AI (batch-based)."""

    __tablename__ = "financial_planning_tip"

    planning_tip_id: Mapped[uuid.UUID] = mapped_column(
        PG_UUID(as_uuid=True), primary_key=True, default=uuid.uuid4
    )
    ...
    resources: Mapped[list[dict]] = mapped_column(JSON, nullable=False)
